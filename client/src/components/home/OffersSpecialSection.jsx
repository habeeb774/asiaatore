    ...
    return (
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          >
            <div className="inline-flex items-center justify-center gap-3 rounded-full border border-amber-200/70 bg-white/70 px-5 py-2 text-amber-600 shadow-sm dark:border-amber-500/30 dark:bg-gray-900/70 dark:text-amber-300">
              <Sparkles className="w-4 h-4" />
              <span>لا توجد عروض خاصة مفعلة حالياً</span>
            </div>
            <h2 className="mt-5 text-3xl font-bold text-gray-900 dark:text-white">
              فعّل عروضك الترويجية لعرضها هنا
            </h2>
            <p className="mt-3 text-gray-600 dark:text-gray-300">
              قم بإضافة عروض جديدة من لوحة التحكم أو حدّث بيانات المنتجات بعروض نشطة لعرض هذا القسم للعملاء.
            </p>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              بمجرد توفر عروض حقيقية، سيعرض هذا القسم منتجاتك المميزة مع الأسعار المخفضة والصور المحدثة.
            </p>
          </MotionDiv>
        </div>
      </section>
