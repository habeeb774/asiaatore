      ...
      <fieldset style={{display:'grid', gap:8, border:'1px solid #e2e8f0', borderRadius:8, padding:12}}>
        ...
        <div style={{display:'grid', gridTemplateColumns:'var(--cols-3)', gap:8}}>
          <label htmlFor="shippingBase" style={{display:'grid', gap:4}}>
            ...
            {errors.shippingBase && <small style={{color:'var(--color-danger)'}}>{errors.shippingBase}</small>}
          </label>
          <label htmlFor="shippingPerKm" style={{display:'grid', gap:4}}>
            ...
            {errors.shippingPerKm && <small style={{color:'var(--color-danger)'}}>{errors.shippingPerKm}</small>}
          </label>
          <label htmlFor="shippingMin" style={{display:'grid', gap:4}}>
            ...
            {errors.shippingMin && <small style={{color:'var(--color-danger)'}}>{errors.shippingMin}</small>}
          </label>
          <label htmlFor="shippingMax" style={{display:'grid', gap:4}}>
            ...
            {errors.shippingMax && <small style={{color:'var(--color-danger)'}}>{errors.shippingMax}</small>}
          </label>
          <label htmlFor="shippingFallback" style={{display:'grid', gap:4}}>
            ...
            {errors.shippingFallback && <small style={{color:'var(--color-danger)'}}>{errors.shippingFallback}</small>}
          </label>
          <div style={{display:'grid', gridTemplateColumns:'var(--cols-2)', gap:8}}>
            <label htmlFor="originLat" style={{display:'grid', gap:4}}>
              ...
              {errors.originLat && <small style={{color:'var(--color-danger)'}}>{errors.originLat}</small>}
            </label>
            <label htmlFor="originLng" style={{display:'grid', gap:4}}>
              ...
              {errors.originLng && <small style={{color:'var(--color-danger)'}}>{errors.originLng}</small>}
            </label>
          </div>
        </div>
