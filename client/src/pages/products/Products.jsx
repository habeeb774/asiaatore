    ...
    <div ref={ptrRef} className="offers-page catalog-page container-custom px-4 py-8" style={{ willChange: 'transform', touchAction: 'pan-x pan-y' }}>
      ...
      <div className="md:hidden mb-3 flex justify-between items-center">
        ...
        >
          ...
          {locale==='ar' ? 'تصفية المنتجات' : 'Filters'}
        </Button>
      ...
      {mobileFiltersOpen && (
        <div id="mobile-product-filters" className="fixed inset-0 z-50 md:hidden" role="dialog" aria-modal="true">
          ...
          {error && (
            <div className="mb-4 rounded-lg border border-red-200 bg-red-50 p-4 text-sm text-red-800">
              <p className="font-semibold mb-1">
                {locale==='ar' ? 'تعذر تحميل المنتجات' : 'Could not load products'}
              </p>
              <p className="mb-3">
                {locale==='ar'
